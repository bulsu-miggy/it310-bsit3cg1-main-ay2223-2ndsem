...
if(isset($_POST['save']))
{
	...
	{
		$pass=md5($pass1);
		$insert="INSERT INTO `users` (`username`, `email`, `password`, `user`) VALUES ('$user', '$email', '$pass','1')";

		if(mysqli_query($con,$insert))
		{
		success("<h1 style='color:white;text-align:center;'>Insert Successfully</h1>");
		}else{
		error("Failed in inserting Data");
		}
	}
	else{
		error("<h1 style='color:white;text-align:center;'>Password must be same.</h1>");
	}
 
}
?>

	<h1 class="page-header text-center" style="color:white;">Manage Admin</h1>
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
		<ul class="nav navbar-nav navbar-right">
	      	<li class="well-sm"><button class="btn btn-primary " data-toggle="modal" data-target="#flipFlop" style="color: white;">Add Admin 
			...
			<table class="table table-bordered text-center tble">
				...
				<?php
					$select="SELECT * FROM users where user ='1'";
				...
				<tr>
					...
					<td>
						<a href="d-adm.php?delete=<?php echo $row['id']?>" class="btn btn-danger btn-sm">
							<span class="glyphicon glyphicon-trash"></span>
						</a>
						<a href="u-adm.php?update=<?php echo $row['id']?>" class="btn btn-success" name="save">
