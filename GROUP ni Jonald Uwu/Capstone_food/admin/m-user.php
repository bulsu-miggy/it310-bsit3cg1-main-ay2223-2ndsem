...
?>
	...
	<h1 class="page-header text-center"  style="color:white;">Manage Users</h1>
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
		<ul class="nav navbar-nav navbar-right">
	      	<li class="well-sm"><button class="btn btn-primary " data-toggle="modal" data-target="#flipFlop" style="color: white;">Add User 
