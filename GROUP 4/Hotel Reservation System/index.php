...
">
        <div class="container"style=" margin-top: 0;">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php"style="color: white;">Home</a></li>
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="roomsvisitors.html"style="color: white;">Rooms</a></li>
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="Galleryvisitors.html"style="color: white;">Gallery</a></li>
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="aboutvisitors.html"style="color: white;">About</a></li>
                <ul class="navbar-nav ml-auto my-2 my-lg-0">
                <li class= "social"><a href="#"style="color: white; font-size: 25px; padding: 5px;"><i class="fa fa-facebook-square"></i></a></li>
                <li class= "social"><a href="#"style="color: white; font-size: 25px; padding: 5px;"><i class="fa fa-twitter"></i></a></li>
                <li class= "social"><a href="#"style="color: white; font-size: 25px; padding: 5px;"><i class="fa fa-instagram"></i></a></li>
                    <button><li class="nav-item"><a class="nav-link js-scroll-trigger" href="signup.php"style="color: white;">Register</a></li></button>
                    <button><li class="nav-item"><a class="nav-link js-scroll-trigger" href="login.php"style="color: white;">Log In</a></li></button>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="about_area">
        <div class="container">
			...
			the city's largest and most comprehensive meeting and 
				event facilities</p>
                        <a href="aboutvisitors.html" class="line-button">Learn More</a>
                    </div>
                </div>
